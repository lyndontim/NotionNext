...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是袁智才, 感谢你陪我紧追全球医药前沿资讯,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '袁智才', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个关注前沿资讯的医药人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gzbiocar.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '袁智才,贝尔卡,医药前沿资讯,新药动态', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '4696999@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU |https://www.xiaohongshu.com/user/profile/67231893000000001c0190b5| '', // 小红书主页
  CONTACT_ZHISHIXINGQIU: process.env.NEXT_PUBLIC_CONTACT_ZHISHIXINGQIU || '', // 知识星球
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【
AI-aite-Cloud】==#wechat_redirect', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【
AI-aite-Cloud】==#wechat_redirect
